...
def plot_metrics(folder_path, name, window_size=100):
    ...
    axs[1].plot(range(window_size-1, len(episode_rewards)), running_avg, label=f'Running Average ({window_size})', color='orange')
...
plot_combined_smoothed_rewards([run6_avg, run12_avg], ['Initial Run', 'Framestack'], window_size)